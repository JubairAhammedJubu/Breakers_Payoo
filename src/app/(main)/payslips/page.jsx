...
const PaySlipGenerator = () => {
  ...
  // Load employees from public folder
  useEffect(() => {
  ...
  const payslip = employee
    ? calculatePayroll(employee, selectedPeriod, overtimeHours, absentDays)
    : null;
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-red-50 dark:bg-red-900/20 p-6 rounded-xl border border-red-200 dark:border-red-800">
                  ...
                  <div className="space-y-4">
                    ...
                    {payslip.deductions.absent > 0 && (
                      <div className="flex justify-between py-2">
                        <span className="text-slate-700 dark:text-slate-300 font-medium">
                          Absent Deduction ({absentDays} days)
                        </span>
                        <span className="font-bold text-slate-900 dark:text-white">
                          {formatCurrency(payslip.deductions.absent)}
                        </span>
                      </div>
                    )}
